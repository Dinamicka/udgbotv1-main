...
module.exports = {
  ...
  async run(client, interaction) {
    ...
    Tu trabajo se basa en responder preguntas la documentación oficial del servidor, sin embargo puedes responder cualquier pregunta relacioanda con otro tema.
    ...
    - Si una pregunta relacionada al servidor y no está en el documento, responde: "Esa información no está en las notas oficiales del servidor." de lo contrario, responde normalmente
    ...
    · NO P2W
    · NO Auto-Farm
    · Donation Shop solo objetos cosméticos
